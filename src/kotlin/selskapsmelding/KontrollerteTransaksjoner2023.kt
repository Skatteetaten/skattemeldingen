...
object KontrollerteTransaksjoner2023 : HarKalkylesamling {
    ...
    internal val samletGarantiansvarPerTransaksjonsmotpart = kalkyle("samletGarantiansvarPerTransaksjonsmotpart") {
        forAlleForekomsterAv(modellV2.transaksjonsmotpart) {
    ...
    internal val samletGarantiansvar = kalkyle("samletGarantiansvar") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletGarantiansvar) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletGarantigrunnlag = kalkyle("samletGarantigrunnlag") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletGarantigrunnlag) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletEkstraordinaerTransaksjonKnyttetTilSalgEllerOverfoering =
        kalkyle("samletEkstraordinaerTransaksjonKnyttetTilSalgEllerOverfoering") {
            settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletEkstraordinaerTransaksjonKnyttetTilSalgEllerOverfoering) {
                forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletEkstraordinaerTransaksjonKnyttetTilKjoepEllerOvertagelse =
        kalkyle("samletEkstraordinaerTransaksjonKnyttetTilKjoepEllerOvertagelse") {
            settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletEkstraordinaerTransaksjonKnyttetTilKjoepEllerOvertagelse) {
                forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletOperasjonellInntekt = kalkyle("samletOperasjonellInntekt") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletOperasjonellInntekt) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletOperasjonellKostnad = kalkyle("samletOperasjonellKostnad") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletOperasjonellKostnad) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletFinansiellInntekt = kalkyle("samletFinansiellInntekt") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletFinansiellInntekt) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletFinansiellKostnad = kalkyle("samletFinansiellKostnad") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletFinansiellKostnad) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletFordring = kalkyle("samletFordring") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletFordring) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
    ...
    internal val samletGjeld = kalkyle("samletGjeld") {
        settUniktFelt(modellV2.transaksjonDisposisjonOgMellomvaerende.samletGjeld) {
            forekomsterAv(modellV2.transaksjonsmotpart) summerVerdiFraHverForekomst {
