...
internal object GevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente {
        ...
        forekomsterAv(modell.spesifikasjonAvAnleggsmiddel_saerskiltAnleggsmiddelIKraftverk) forHverForekomst {
            ...
            hvis(sumGjenstaaendeSkattemessigVerdiPaaRealisasjonstidspunktet.harVerdi()) {
                ...
                if (realisasjonsVerdi mindreEllerLik 0) {
                    settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_gevinstVedRealisasjon) {
                        realisasjonsVerdi.absoluttverdi()
                    }
                } else {
                    settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_tapVedRealisasjon) {
                        realisasjonsVerdi
                    }
                }
            }
        ...
        kalkyle("grunnlagForAaretsInntektsfoeringOgInntektsfradragKalkyle") {
            forekomsterAv(modell.spesifikasjonAvAnleggsmiddel_saerskiltAnleggsmiddelIKraftverk) forHverForekomst {
                settFelt(grunnlagForAaretsInntektsfoeringOgInntektsfradrag) {
                    forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inngaaendeVerdi +
                        forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_gevinstVedRealisasjon -
                        forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_tapVedRealisasjon
                }
            }
        }
        ...
        kalkyle("inntektEllerInntektsfradragFraGevinstOgTapskontoKalkyle") {
            ...
            forekomsterAv(modell.spesifikasjonAvAnleggsmiddel_saerskiltAnleggsmiddelIKraftverk) forHverForekomst {
                hvis(grunnlagForAaretsInntektsfoeringOgInntektsfradrag.harVerdi()) {
                    ...
                    val sats =
                        forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_satsForInntektsfoeringOgInntektsfradrag.prosent()

                    when {
                        sats.harVerdi() -> {
                            val satsjustertBeloep = beloep * sats
                            if (satsjustertBeloep.erNegativ()) {
                                settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inntektsfradragFraGevinstOgTapskonto) {
                                    satsjustertBeloep.absoluttverdi()
                                }
                            } else {
                                settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inntektFraGevinstOgTapskonto) { satsjustertBeloep }
                            }
                        }
                        ...
                        beloep stoerreEllerLik grenseverdiTo && beloep mindreEnn grenseverdiTre -> {
                            settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inntektFraGevinstOgTapskonto) { beloep }
                        }
                        ...
                        beloep stoerreEnn grenseverdiEn && beloep mindreEnn grenseverdiTo -> {
                            ...
                            val satsjustertBeloep = beloep * justertSats
                            settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inntektsfradragFraGevinstOgTapskonto) { satsjustertBeloep.absoluttverdi() }
                        }
    ...
    internal val utgaaendeVerdiKalkyle = kalkyle("utgaaendeVerdiKalkyle") {
        forekomsterAv(modell.spesifikasjonAvAnleggsmiddel_saerskiltAnleggsmiddelIKraftverk) forHverForekomst {
            hvis(grunnlagForAaretsInntektsfoeringOgInntektsfradrag.harVerdi()) {
                settFelt(forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_utgaaendeVerdi) {
                    grunnlagForAaretsInntektsfoeringOgInntektsfradrag -
                        forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inntektFraGevinstOgTapskonto +
                        forekomstType.gevinstOgTapskontoPerSaerskiltAnleggsmiddelKnyttetTilGrunnrente_inntektsfradragFraGevinstOgTapskonto
                }
            }
        }
    }
