...
object FordeltBeregnetPersoninntektBeregning2021 : HarKalkylesamling {
    ...
    val fordeltBeregnetPersoninntektKalkyle = kalkyle {
        ...
        val resultat = if (skalBeregnePersoninntekt(gm)) {
            ...
            val oppdatertePersoninntektForekomster = gm
                ...
                .grupperV2(modell2021.fordeltBeregnetPersoninntekt)
            ...
            val naeringinntektForekomsterPerIdentifikator: Map<String, List<GeneriskGruppe>> =
                gm.grupperV2(modell2021.fordeltBeregnetNaeringsinntekt)
                ...
                .flatMap { (personinntektIdentifikator, personinntektForekomster) ->
                    ...
                    if (fordeltSkattemessigResultatEtterKorreksjonBeloep != null
                        ...
                        val beregnetAaretsBeregnedePersoninntektFoerFordelingOgSamordning =
                            personinntektForekomst.overstyrtVerdiHvisOverstyrt(modell2021.fordeltBeregnetPersoninntekt.aaretsBeregnedePersoninntektFoerFordelingOgSamordning)
                        ...
                        if (beregnetAaretsBeregnedePersoninntektFoerFordelingOgSamordning.ulik0()) {
                            ...
                            val beregnetAaretsBeregnedePersoninntektFoerFordelingOgSamordningTilordnetInnehaver =
                                personinntektForekomst.overstyrtVerdiHvisOverstyrt(modell2021.fordeltBeregnetPersoninntekt.aaretsBeregnedePersoninntektFoerFordelingOgSamordningTilordnetInnehaver)
    ...
    private fun beregnSkjermingsgrunnlag(
        ...
        return gm.grupperV2(modell2021.fordeltBeregnetPersoninntekt)
            .map { fordeltBeregnetPersoninntektForekomst ->
                ...
                if (gjennomsnittsverdier.isNotEmpty()) {
                    val sumSkjermingsgrunnlagFoerGjeldsfradrag =
                        fordeltBeregnetPersoninntektForekomst.overstyrtVerdiHvisOverstyrt(modell2021.fordeltBeregnetPersoninntekt.sumSkjermingsgrunnlagFoerGjeldsfradrag)
                            ?: beregnSumSkjermingsgrunnlagFoerGjeldsfradrag(gjennomsnittsverdier)

                    val sumSkjermingsgrunnlagEtterGjeldsfradrag =
                        fordeltBeregnetPersoninntektForekomst.overstyrtVerdiHvisOverstyrt(modell2021.fordeltBeregnetPersoninntekt.sumSkjermingsgrunnlagEtterGjeldsfradrag)
                    ...
                    val skjermingsfradrag = fordeltBeregnetPersoninntektForekomst.overstyrtVerdiHvisOverstyrt(modell2021.fordeltBeregnetPersoninntekt.skjermingsfradrag)
