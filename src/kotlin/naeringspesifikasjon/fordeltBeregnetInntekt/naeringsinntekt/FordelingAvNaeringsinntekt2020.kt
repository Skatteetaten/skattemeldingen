...
internal object FordelingAvNaeringsinntekt2020 : HarKalkylesamling {
    ...
    internal val skattemessigResultatForNaeringEtterKorreksjonKalkyle =
        kalkyle("skattemessigResultatForNaeringEtterKorreksjon") {
            forAlleForekomsterAv(modell2020.fordelingAvNaeringsinntekt) {
                settFelt(forekomstType.skattemessigResultatForNaeringEtterKorreksjon) {
                    forekomstType.skattemessigResultatForNaering +
    ...
    internal val skattemessigResultatForNaeringEtterKorreksjonTilordnetInnehaverKalkyle =
        kalkyle("skattemessigResultatForNaeringEtterKorreksjonTilordnetInnehaver") {
            forAlleForekomsterAv(modell2020.fordelingAvNaeringsinntekt) {
                settFelt(forekomstType.skattemessigResultatForNaeringEtterKorreksjonTilordnetInnehaver) {
                    forekomstType.skattemessigResultatForNaeringEtterKorreksjon *
                        forekomstType.andelAvSkattemessigResultatTilordnetInnehaver.prosent()
                }
            }
        }
