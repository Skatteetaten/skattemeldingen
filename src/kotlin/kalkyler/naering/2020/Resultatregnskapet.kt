internal object Resultatregnskapet : HarKalkyletre {
    ...
    private val vederlagVedRealisasjonOgUttakInntektsfoertIAarLinear =
        summer forekomsterAv lineaertavskrevetAnleggsmiddel forVerdi { it.vederlagVedRealisasjonOgUttakInntektsfoertIAar }
    private val vederlagVedRealisasjonOgUttakInntektsfoertIAarIkkeAvskrivbart =
        summer forekomsterAv ikkeAvskrivbartAnleggsmiddel forVerdi { it.vederlagVedRealisasjonOgUttakInntektsfoertIAar }
    private val vederlagVedRealisasjonOgUttakInntektsfoertIAarSaldo =
        summer forekomsterAv saldoavskrevetAnleggsmiddel forVerdi { it.vederlagVedRealisasjonOgUttakInntektsfoertIAar }
    internal val aaretsInntektsfoeringAvNegativSaldo =
        summer forekomsterAv saldoavskrevetAnleggsmiddel forVerdi { it.aaretsInntektsfoeringAvNegativSaldo }
