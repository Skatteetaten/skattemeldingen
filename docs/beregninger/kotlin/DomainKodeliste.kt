object resultatregnskapOgBalanse_2020 : KodeverdierHovedkodeliste() {
    ...
    object balanseverdiForOmloepsmiddel : KodeverdierUnderkodeliste() {
        ...
        val kode_1401 = KodeVerdi("1401", "Selvprodusert vare benyttet i egen produksjon i jordbruk", Kodetillegg(true, listOf("1", "2", "5"), false))
        ...
        val kode_1565 = KodeVerdi("1565", "Kortsiktige fordringer mot personlig eier, styremedlem o.l.", Kodetillegg(true, listOf("1", "2", "5"), false))
        val kode_1570 = KodeVerdi("1570", "Andre kortsiktige fordringer", Kodetillegg(true, listOf("1", "2", "5"), false))
        val kode_1780 = KodeVerdi("1780", "Krav på innbetalt selskapskapital", Kodetillegg(true, listOf("1", "2", "5"), false))
        val kode_1800 = KodeVerdi("1800", "Ikke-markedsbaserte aksjer og verdipapirfondsandeler", Kodetillegg(true, listOf("1", "2", "5"), true))
    ...
    object egenkapital : KodeverdierUnderkodeliste() {
        ...
        val kode_2043 = KodeVerdi("2043", "Fond for vurderingsforskjeller", Kodetillegg(true, listOf("2"), false))
        val kode_2045 = KodeVerdi("2045", "Fond for urealiserte gevinster", Kodetillegg(true, listOf("2"), false))
        val kode_2055 = KodeVerdi("2055", "Avsatt utbytte - IFRS", Kodetillegg(true, listOf("2"), false))
        val kode_2080 = KodeVerdi("2080", "Udekket tap", Kodetillegg(true, listOf("1", "2"), false))
        val kode_2015 = KodeVerdi("2015", "Felleseid andelskapital", Kodetillegg(true, listOf("1", "2"), false))
    ...
    object annenDriftsinntekt : KodeverdierUnderkodeliste() {
        ...
        val kode_3850 = KodeVerdi("3850", "Verdiendringer av investeringseiendommer etter IFRS", Kodetillegg(true, listOf("2"), false))
        val kode_3870 = KodeVerdi("3870", "Verdiendringer biologiske eiendeler etter IFRS", Kodetillegg(true, listOf("2"), false))
    ...
    object annenDriftskostnad : KodeverdierUnderkodeliste() {
        ...
        val kode_7830 = KodeVerdi("7830", "Tap på fordringer", Kodetillegg(true, listOf("1", "2", "5"), false))
