...
Versjon 1 av denne XSD'en ligger vedlagt og heter "naeringsopplysninger_v1.xsd"
Eksempel på innsendt XML fil fra et enkeltpersonforetak ligger vedlagt og heter "Naeringsopplysninger_ENK_Eksempel.xml" 
Grafisk fremstilling ligger vedlagt og heter "Næringsopplysninger UML modell.pdf"
"Mapping" mellom informasjonselementer i XSD'en og postnummer/OR-id i eksisterende RF-skjemaer ligger vedlagt og heter "Mapping_Xpath_Skjema_Orid.xlsx"
